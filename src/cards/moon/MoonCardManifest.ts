...
export const MOON_CARD_MANIFEST = new CardManifest({
  ...
  projectCards: [
    ...
    {cardName: CardName.TYCHO_ROAD_NETWORK, Factory: TychoRoadNetwork},
  ...
  corporationCards: [
    ...
    {cardName: CardName.THE_DARKSIDE_OF_THE_MOON_SYNDICATE, Factory: TheDarksideofTheMoonSyndicate, compatibility: GameModule.Moon},
    {cardName: CardName.LUNA_HYPERLOOP_CORPORATION, Factory: LunaHyperloopCorporation, compatibility: GameModule.Moon},
    {cardName: CardName.CRESCENT_RESEARCH_ASSOCIATION, Factory: CrescentResearchAssociation, compatibility: GameModule.Moon},
    {cardName: CardName.LUNA_FIRST_INCORPORATED, Factory: LunaFirstIncorporated, compatibility: GameModule.Moon},
    {cardName: CardName.THE_GRAND_LUNA_CAPITAL_GROUP, Factory: TheGrandLunaCapitalGroup, compatibility: GameModule.Moon},
    {cardName: CardName.INTRAGEN_SANCTUARY_HEADQUARTERS, Factory: IntragenSanctuaryHeadquarters, compatibility: GameModule.Moon},
    // {cardName: CardName.LUNA_TRADE_FEDERATION, Factory: LunaTradeFederation},
    {cardName: CardName.THE_ARCHAIC_FOUNDATION_INSTITUTE, Factory: TheArchaicFoundationInstitute, compatibility: GameModule.Moon},
  ],
  standardProjects: [
