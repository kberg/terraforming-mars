...
export const ALL_TURMOIL_ACTION_CARD_NAMES = allCardNames([TURMOIL_CARD_MANIFEST.turmoilActions]);
...
export const ALL_LEADER_CARD_NAMES = allCardNames([LEADER_CARD_MANIFEST.leaderCards]);
