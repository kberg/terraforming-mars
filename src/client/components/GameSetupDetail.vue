...
const boardColorClass: Record<BoardName, string> = {
  ...
  [BoardName.VASTITAS_BOREALIS_NOVA]: 'game-config board-vastitas_borealis_novus map',
  [BoardName.TERRA_CIMMERIA_NOVA]: 'game-config board-terra_cimmeria_novus map',
