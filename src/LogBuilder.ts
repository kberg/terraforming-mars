...
export class LogBuilder {
    ...
    public globalEvent(value: IGlobalEvent): LogBuilder {
      this.parameters.push(new LogMessageData(LogMessageDataType.GLOBAL_EVENT, value.name));
      return this;
    }

    public globalEventName(value: GlobalEventName): LogBuilder {
      this.parameters.push(new LogMessageData(LogMessageDataType.GLOBAL_EVENT, value));
      return this;
    }
