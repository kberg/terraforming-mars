...
function getWaitingFor(
  ...
  case PlayerInputTypes.SELECT_PRODUCTION_TO_LOSE:
    ...
    playerInputModel.payProduction = {
      ...
      units: {
        megacredits: _player.megaCreditProduction,
        steel: _player.steelProduction,
        titanium: _player.titaniumProduction,
        plants: _player.plantProduction,
        energy: _player.energyProduction,
        heat: _player.heatProduction,
      },
    };
    break;
