  ...
  constructor() {
    super({
      ...
      metadata: {
        ...
        description: 'Gain 1 TR. Place an ocean tile on any non-reserved space on Mars, ' +
          'ignoring placement restrictions. Then excavate the underground resource in that space.',
      },
    });
  }
