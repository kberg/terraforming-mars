...
export const CardRenderItemComponent = Vue.component('CardRenderItemComponent', {
  ...
  methods: {
    getComponentClasses: function(): string {
      ...
      } else if (type === CardRenderItemType.BLANK_TAG) {
        classes.push('card-resource-blank');

        if (this.item.size === Size.SMALL) {
          classes.push('card-tag-small');
        } else {
          classes.push('card-tag-medium');
        }
      ...
      } else if (type === CardRenderItemType.EMPTY_TAG) {
        classes.push('card-tag-none');
      ...
      } else if (type === CardRenderItemType.MISINFORMATION) {
        classes.push('misinformation');
      }
      ...
      if (this.item.isPlayed) {
        ...
        if (type === CardRenderItemType.EVENT) {
          ...
          if (this.item.size === undefined) {
            ...
            classes.push('card-tag-wild card-tag-medium');
          }
        }
      }
