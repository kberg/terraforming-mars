...
describe('Predators', function() {
  let card : Predators; let player : Player; let player2 : Player; let game : Game; let fish: IProjectCard;
  ...
  beforeEach(() => {
    ...
    fish = {resourceType: ResourceType.ANIMAL, resourceCount: 0} as IProjectCard;
  });
  ...
  it('Should act', function() {
    const smallAnimals = {resourceType: ResourceType.ANIMAL, resourceCount: 0} as IProjectCard;
  ...
  it('Respects protected habitats', function() {
    player.playedCards.push(card);
    const animals = {resourceType: ResourceType.ANIMAL, resourceCount: 0} as IProjectCard;
