...
describe('GeoscanSatellite', () => {
  it('play', () => {
    ...
    expect(game.board.spaces.filter((space) => space.undergroundResources !== undefined)).is.empty;
    ...
    expect(game.board.spaces.filter((space) => space.undergroundResources !== undefined)).to.have.members(expected);
