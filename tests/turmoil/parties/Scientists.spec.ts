...
import {Scientists, SCIENTISTS_BONUS_1, SCIENTISTS_BONUS_2, SCIENTISTS_DEFAULT_POLICY, SCIENTISTS_POLICY_2, SCIENTISTS_POLICY_3, SCIENTISTS_POLICY_4} from '../../../src/turmoil/parties/Scientists';
...
describe('Scientists', function() {
  ...
  it('Ruling policy 1: Pay 10 M€ to draw 3 cards', function() {
    TestingUtils.setRulingPartyAndRulingPolicy(game, turmoil, scientists, SCIENTISTS_DEFAULT_POLICY.id);
