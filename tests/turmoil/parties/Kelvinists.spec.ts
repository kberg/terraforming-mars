...
import {Kelvinists, KELVINISTS_BONUS_1, KELVINISTS_BONUS_2, KELVINISTS_DEFAULT_POLICY, KELVINISTS_POLICY_2, KELVINISTS_POLICY_3, KELVINISTS_POLICY_4} from '../../../src/turmoil/parties/Kelvinists';
...
describe('Kelvinists', function() {
  ...
  it('Ruling policy 1: Pay 10 M€ to increase your Energy and Heat production 1 step', function() {
    ...
    TestingUtils.setRulingPartyAndRulingPolicy(game, turmoil, kelvinists, KELVINISTS_DEFAULT_POLICY.id);
