    ...
    expect(JSON.parse(res.content)).deep.eq(
      {
        ...
        'gameOptions': {
          'aresExtension': false, 'boardName': 'tharsis', 'cardsBlackList': [], 'coloniesExtension': false, 'communityCardsOption': false, 'colosseumVariant': false, 'newOpsExpansion': false, 'archaeologyExtension': false, 'corporateEra': true, 'draftVariant': false, 'fastModeOption': false, 'initialDraftVariant': false, 'moonExpansion': false, 'preludeExtension': false, 'promoCardsOption': false, 'politicalAgendasExtension': 'Standard', 'showTimers': true, 'shuffleMapOption': false, 'societyExpansion': false, 'silverCubeVariant': false, 'solarPhaseOption': false, 'soloTR': false, 'randomMA': 'No randomization', 'randomTurmoil': false, 'turmoilExtension': false, 'venusNextExtension': false, 'requiresVenusTrackCompletion': false, 'escapeVelocityMode': false,
        },
      },
    );
  });
